...
10. **Beck, Nathaniel. (2008)**: "[Time-Series Cross-Section Methods" Methods in time-series cross-section](https://academic.oup.com/edited-volume/28340). *In Oxford Handbook of Political Methodology, edited by Janet M Box-Steffensmeier, Henry E Brady, and David Collier.* 
...
15. **Fernández-Val, Iván and Martin Weidner. (2018)**: "[Fixed Effects Estimation of Large-T Panel Data Models](https://www.annualreviews.org/doi/10.1146/annurev-economics-080217-053542)." *Annual Review of Economics, 10:109–138.* 
...
7. **Strezhnev, Anton. (2018)**: "[Semiparametric Weighting Estimators for Multi-Period Difference-in-Differences Designs](https://static1.squarespace.com/static/5931baca440243906ef65ca3/t/5b807c5d0ebbe8b9b8c75878/1535147102290/generalized_did.pdf)." *Annual Conference of the American Political Science Association.* 
...
4. **Doudchenko, Nikolay and Guido W Imbens. (2016)**: "[Balancing, Regression, Difference-In-Differences and Synthetic Control Methods: A Synthesis](https://arxiv.org/abs/1610.07748)." *arXivpreprint arXiv:1610.07748.*
...
8. **Chernozhukov, Victor, Kaspar Wuthrich, and Yinchu Zhu. (2017)**: "[An Exact and Robust Conformal Inference Method for Counterfactual and Synthetic Controls](https://arxiv.org/abs/1712.09089)." *arXivpreprint arXiv:1712.09089.*
...
12. **Cattaneo, Matias D., Yingjie Feng, and Rocio Titiunik. (2019)**: [Prediction Intervals for Synthetic Control Methods](https://arxiv.org/abs/1912.07120)." *arXivpreprint arXiv:1912.07120.*
...
5. **Morgan, S. L., & Winship, C. (2014)**: "[Counterfactuals and Causal Inference: Methods and Principles for Social Research](https://www.cambridge.org/core/books/counterfactuals-and-causal-inference/5CC81E6DF63C5E5A8B88F79D45E1D1B7)." *Cambridge University Press.* 
...
1. **Hazlett, Chad and Yiqing Xu. (2018)**: "[Trajectory Balancing: A General Reweighting Approach to Causal Inference With Time-Series Cross-Sectional Data](https://ssrn.com/abstract=3214231)." 
2. **Blackwell, Matthew and Adam Glynn. (2018)**: "[How to Make Causal Inferences with Time-Series Cross-Sectional Data Under Selection on Observables](https://doi.org/10.1017/S0003055418000357)." *The American Political Science Review, 112(2):1067–1082.* 
3. **Imai, Kosuke and In Song Kim. (2019)**: "[When Should We Use Unit Fixed Effects Regression Models for Causal Inference with Longitudinal Data?](https://doi.org/10.1111/ajps.12417)." Journal of the American Journal of Political Science,Vol. 63, No. 2: 467–490.*
4. **Aronow, Peter M, Cyrus Samii, and Ye Wang. (2020)**: "[Design-Based Inference for Spatial Experiments with Interference](https://doi.org/10.48550/arXiv.2010.13599)." 
...
6. **Ying, Andrew, Wang Miao, Xu Shi, and Eric J Tchetgen Tchetgen. (2021)**: "[Proximal Causal Inference for Complex Longitudinal Studies](https://doi.org/10.48550/arXiv.2109.07030)." *arXivpreprint arXiv:2109.07030*
...
8. **Arkhangelsky, D. and Imbens, G. W. (2022)**: "[Double-Robust Identification for Causal Panel Data Models](https://doi.org/10.1093/ectj/utac019)." *The Econometrics Journal, Volume 25, Issue 3: 649–674.* 
...
2. **Blackwell, Matthew. (2013)**: "[A Framework for Dynamic Causal Inference in Political Science](https://doi.org/10.1111/j.1540-5907.2012.00626.x)." *American Journal of Political Science 57(2):504–520.*
...
4. **Imai, Kosuke, In Song Kim, and Erik Wang. (2023)**: "[Matching Methods for Causal Inference with Time-Series Cross-Section Data](https://doi.org/10.1111/ajps.12685)." *American Journal of Political Science, Vol. 67, No. 3: 587–605.* 
