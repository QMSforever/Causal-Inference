...
3. **Imai, Kosuke and In Song Kim. (2019)**: "[When Should We Use Unit Fixed Effects Regression Models for Causal Inference with Longitudinal Data?](https://doi.org/10.1111/ajps.12417)." This paper addresses the use of fixed effects models for causal analysis with longitudinal data.
